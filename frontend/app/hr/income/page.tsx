...
export default function HrIncomePage() {
  const currentUserId = "2"; // Mock logged-in user (HR Manager)
  ...
  return (
    <div className="space-y-8 max-w-4xl mx-auto">
      <div>
        <h1 className="text-2xl font-bold tracking-tight text-gray-900">Thu nhập của tôi (Nhân sự)</h1>
        <p className="text-gray-500">Xem phiếu lương và lịch sử thu nhập cá nhân.</p>
      </div>
